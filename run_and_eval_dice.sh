...
# train
nohup python DICE.py --cuda ${use_cuda} --init_AE_epoch 1 --n_hidden_fea  $n_hidden_fea --output_path "./output/${dataset}/" \
...
# Architecture search
# nohup python NAS_DICE.py --cuda ${use_cuda} --training_output_path "./output/${dataset}/" --input_path "./dataset/${dataset}/" \
...
# metrics
nohup python clustering_metrics.py --cuda ${use_cuda} --training_output_path "./output/${dataset}/" --input_path "./dataset/${dataset}/" \
--filename_train "datatrain.pkl" --filename_valid "datavalid.pkl" --filename_test "datatest.pkl" \
...
# outcome prediction
nohup python outcome_prediction.py --cuda ${use_cuda} --training_output_path "./output/${dataset}/" --input_path "./dataset/${dataset}/" \
--filename_train "datatrain.pkl" --filename_valid "datavalid.pkl" --filename_test "datatest.pkl" \
--n_input_fea ${n_input_fea} --n_dummy_demov_fea ${n_dummy_demov_fea} --K_clusters ${K_clusters} \
...
# visual
nohup python representation_visualization.py --cuda ${use_cuda} --training_output_path "./output/${dataset}/" \
